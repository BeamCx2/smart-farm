        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-gray-800 h-fit lg:sticky lg:top-24">
                    ...
                    <Link
                        to="/checkout"
                        className="block w-full text-center mt-6 py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold shadow-lg shadow-emerald-600/20 transition-all"
                    >
                        ดำเนินการชำระเงิน →
                    </Link>
